...
/**
 * Akcija dodavanja novog korisnika. Novi korisnik ima anonimna prava {@link com.raf.sk.core.user.Privilege}, odnosno prava se dodaju
 * odvojenom akcijom.
 * <p>
 * Trenutni korisnik mora imati adekvatna prava za dodavanje ({@link com.raf.sk.core.user.PrivilegeType#ALL} ili
 * {@link com.raf.sk.core.user.PrivilegeType#USER_ADD}.
 * <p>
 *
 * @see com.raf.sk.core.exceptions.IUserDuplicateUsernameException Greška ukoliko korisnik pokuša da napravi korisnika
 */
