...
/**
 * Korisnička radnja dodavanja novog ograničenja za zadati čvor {@link com.raf.sk.specification.repository.INode} (ili za celo skladište ako je
 * putanja jednaka {@link com.raf.sk.specification.repository.Directory#ROOT_DIRECTORY}.
 *
 * @see com.raf.sk.specification.repository.limitations.INodeLimitation
 */
public class ActionAddLimit implements IAction {

    /**
     * Putanja do {@link com.raf.sk.specification.repository.INode} na kome je ograničenje sprovedeno.
     */
    private String path;

    /**
     * Tip ograničenja, vrednost mora biti jedna od vrednosti {@link com.raf.sk.specification.repository.limitations.INodeLimitationType}.
     */
