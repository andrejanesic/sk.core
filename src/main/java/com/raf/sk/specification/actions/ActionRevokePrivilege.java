...
/**
 * Ovom komandom korisink {@link IUser} oduzima od drugog korisnika određenu {@link com.raf.sk.specification.user.Privilege} generalnog ili
...
public class ActionRevokePrivilege implements IAction {
     ...
     */
    public ActionRevokePrivilege(String username, String type, String referencedObject) {
     ...
     * @param type     Tip privilegije kao String.
     */
    public ActionRevokePrivilege(String username, String type) {
