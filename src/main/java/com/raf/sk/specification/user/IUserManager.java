...
public interface IUserManager {
     ...
     * Ovaj metod NE deinicijalizuje skladište, to se mora uraditi preko {@link com.raf.sk.specification.storage.IStorageManager} komponente.
     *
    ...
    /**
     * Dodaje novog korisnika u {@link com.raf.sk.specification.config.IConfigManager} i vraća instancu {@link IUser}. Ovaj korisnik NEĆE biti
     ...
     * @throws com.raf.sk.specification.exceptions.IUserDuplicateUsernameException Ukoliko je dato isto korisničko ime za novog korisnika kao ime
    ...
    /**
     * Dodaje novog {@link IUser} u {@link com.raf.sk.specification.config.IConfigManager} i vraća instancu {@link IUser}.
     *
    ...
    /**
     * Vraća {@link Collection} svih učitanih {@link IUser} preko {@link com.raf.sk.specification.config.IConfigManager}-a.
     *
    ...
    /**
     * Briše {@link IUser} iz instance kao i iz konfiguracije putem {@link com.raf.sk.specification.config.IConfigManager}.
     * <p>
     * Nije moguće obrisati trenutno instanciranog korisnika. To izbacuje
     * {@link com.raf.sk.specification.exceptions.IUserCannotDeleteCurrentUserException}.
     *
     * @param username Korisničko ime {@link IUser} koga treba obrisati.
     * @throws com.raf.sk.specification.exceptions.IUserCannotDeleteCurrentUserException Ukoliko korisnik pokuša da obriše {@link IUser} koji je
