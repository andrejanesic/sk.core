...
/**
 * Ovom komandom korisink {@link com.raf.sk.specification.user.IUser} daje drugom korisniku određenu {@link com.raf.sk.specification.user.Privilege} generalnog ili
 * preciznog (referncira objekat) tipa.
 * <p>
 * Ulogovani korisnik mora imati bar privilegiju {@link com.raf.sk.specification.user.PrivilegeType} PRIVILEGE_GRANT kako bi davao privilegije,
 * odnosno {@link com.raf.sk.specification.user.PrivilegeType} PRIVILEGE_REVOKE kako bi ih oduzimao. Obe su potrebne da bi komanda radila kako
...
public class ActionGrantPrivilege implements IAction {
     ...
     *
     * @see com.raf.sk.specification.user.PrivilegeType
     */
    private String type;
